'use strict';
// toda função tem acesso as variaveis do ambiente de contexto da execução em que a função foi criada
// closure: ambiente da variavel é ligada a uma função, exatamente do lugar e no tempo que função foi criada
